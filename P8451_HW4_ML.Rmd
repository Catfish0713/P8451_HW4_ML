...
* Yes, the clusters changed. For my research question, I want to find tightly knit clusters and the data contains outliers(in Rape), so compared with 'single' I think 'complete' is better. The gap statistic graph also shows an obvious 'elbow' at k=4(compared with using 'single' method). Changing set seeds didn't change the clusters a lot,indicating that the data has a strong inherent tighter clustering structure. 
