...
Here, I would build the two models based on my knowledge. I built my model2 from scratch manually. But actually, model builded using the whole dataset might lead to increased risk of overfitting of the trained model.


```{r manually_model_building, message=FALSE, warning=FALSE}
...
for (predictor in predictors) {
  ...
  model1 = lm(healthyday ~ hypertension + pa_walk_day, data = hw4data)
